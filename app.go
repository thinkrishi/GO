...
// package main --
// fmt.Print("rishi") -- ths is the print statement using fmt.print function to print the string "rishi" to the console.
// import "fmt" -- this is the import statement to include the fmt package which provides formatting for input and output.
// package main -- this is the declaration of the main package which is the entry point of the Go program.
// "" -- only double quotes are used for string literals in Go, so the string "rishi" is enclosed in double quotes.
